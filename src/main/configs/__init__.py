...
COLOR_WORKPLACE_BOLT_BACKGROUND_WAITING = "#D9D9D9"         # 默认参数 - 颜色 - 工作台主要工作区域-产品展示区域-螺丝点位背景_等待中
COLOR_WORKPLACE_BOLT_BACKGROUND_WORKING = "#FAFF18"         # 默认参数 - 颜色 - 工作台主要工作区域-产品展示区域-螺丝点位背景_工作中
COLOR_WORKPLACE_BOLT_BACKGROUND_DONE = COLOR_COMMON_GREEN   # 默认参数 - 颜色 - 工作台主要工作区域-产品展示区域-螺丝点位背景_已完成
COLOR_WORKPLACE_BOLT_BACKGROUND_ERROR = COLOR_COMMON_RED    # 默认参数 - 颜色 - 工作台主要工作区域-产品展示区域-螺丝点位背景_错误
